...
namespace Primavera.Inventory
{
    public partial class InventoryForm : Form
    {
        ...
        {
            InvBEInventario Inventory = new InvBEInventario()
            {
            ...
            try
            {
                if (documentLinesListView.Items.Count > 0)
                {
                    ...
                    {
                        //Insert lines.
                        Inventory.Linhas.Add(line.InventoryLines);
                    }
                }
                else
                {
                ...
                PriEngine.Engine.Inventario.Inventarios.Actualiza(Inventory, errors);
